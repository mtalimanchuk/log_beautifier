...
class Log:
    def __init__(self, timestamp, log_level, instance, message, stack_trace=None):
    ...
    for log_line in event_log:
        ...
        try:
            ...
            try:
                ...
                log = Log(timestamp, str(log_level), str(instance), str(message), str(stack_trace))
...
def _filter_by_instance(event, instance_name):
    ...
    if instance_name in event.instance:
        return True
    else:
        return False
